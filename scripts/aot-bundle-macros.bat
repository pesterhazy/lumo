...
echo "(require 'lumo.build.api 'lumo.analyzer 'lumo.cljs-deps 'lumo.closure 'lumo.compiler 'lumo.io 'lumo.json 'lumo.util 'clojure.core.reducers 'clojure.zip 'clojure.data 'cljs.nodejs 'cljs.test 'cljs.analyzer.api) (require-macros 'lumo.repl 'lumo.util 'clojure.template 'cljs.spec 'cljs.spec.impl.gen 'cljs.test 'cljs.reader 'cljs.env.macros 'cljs.analyzer.macros 'cljs.compiler.macros)" | build\lumo.exe --quiet -c target -sdk lumo-cljs/out/macros-tmp || goto :error
...
mv lumo-cljs\out\macros-tmp\cljs_SLASH_test.js target\cljs\test.js
mv lumo-cljs\out\macros-tmp\cljs_SLASH_test.cache.json target\cljs\test.cache.json
...
mv lumo-cljs\out\macros-tmp\cljs_SLASH_env_SLASH_macros$macros.js target\cljs\envmacros$macros.js || goto :error
